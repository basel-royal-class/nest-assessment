...
let CartItemsRepository = class CartItemsRepository extends typeorm_1.Repository {
    dataSource;
    constructor(dataSource) {
        super(cart_item_entity_1.CartItemEntity, dataSource.createEntityManager());
        this.dataSource = dataSource;
    }
    async createOrder(createCartItemDto) {
