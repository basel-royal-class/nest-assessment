...
const order_items_repository_1 = require("./order.items.repository");
...
exports.OrderItemsModule = OrderItemsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [order_items_service_1.OrderItemsService, order_items_repository_1.OrderItemsRepository]
    })
], OrderItemsModule);
